...
#define setmaybe(obj) { TValue *io=(obj); settt_(io, LUA_TMAYBE); }

#define setgcovalue(L,obj,x) { TValue *io = (obj); GCObject *i_g=(x); \
...
#define setuvalue(L,obj,x) { TValue *io = (obj); Udata *x_ = (x); \
        val_(io).gc = obj2gco(x_); settt_(io, ctb(LUA_TUSERDATA)); \
        checkliveness(G(L),io); }

#define setthvalue(L,obj,x) { TValue *io = (obj); lua_State *x_ = (x); \
        val_(io).gc = obj2gco(x_); settt_(io, ctb(LUA_TTHREAD)); \
        checkliveness(G(L),io); }

#define setclLvalue(L,obj,x) { TValue *io = (obj); LClosure *x_ = (x); \
        val_(io).gc = obj2gco(x_); settt_(io, ctb(LUA_TLCL)); \
        checkliveness(G(L),io); }

#define setclCvalue(L,obj,x) { TValue *io = (obj); CClosure *x_ = (x); \
        val_(io).gc = obj2gco(x_); settt_(io, ctb(LUA_TCCL)); \
        checkliveness(G(L),io); }

#define sethvalue(L,obj,x) { TValue *io = (obj); Table *x_ = (x); \
...
#define getstr(ts) check_exp(sizeof((ts)->extra), cast(const char*, getaddrstr(ts)))
